...
inline void exec(int wl, 
  ...
  auto func = [idx, &init_keys, &values, &next_thread_id, index_type](const tbb::blocked_range<size_t>& r) {
...
int main(int argc, char *argv[]) {
  ...
  if (argc < 5) {
    ...
    std::cout << "3. index type: bwtree skiplist masstree artolc btreeolc btreertm hydralist wormhole hashtable\n";
